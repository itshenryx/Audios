        ...
        <main class="container2">
            ...
            <div class="right-column">
                ...
                <div class="product-description">
                    ...
                    <?php echo '<div class="flex-box"><input id="name" value="'.$row['bookName'].'"><span class="likes" DRAGGABLE="true">'.$likes.' <i class="fa-regular fa-heart"></i></span></div>'; ?>
                    <?php echo '<textarea class="description">'.$row['about'].'</textarea>'; ?>

                    <script>
                        let input = document.getElementById("name"); // get the input element
